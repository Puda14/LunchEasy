        ...
        <div className="flex flex-col w-full h-full relative">
          ...
          <div className="pt-20 pl-20 pr-20 w-full h-full flex flex-col text-2xl">
            <div className="flex flex-row h-1/2 w-full">
              <div className="w-1/3 h-full bg-red-200 items-center flex flex-col pt-4 pl-4 pr-8 text-lg">
                レストラン名
                <div className="h-4/5 w-5/6 m-2 bg-white">Image</div>
                <div className="text-2xl">..................</div>
              </div>
              <div className="w-2/3 h-full bg-green-200 flex flex-col p-3">
            ...
            <div className="bg-blue-200 h-1/2 w-full grid grid-cols-7 grid-rows-2 p-2">
              <div className="bg-white"></div>
              <div className="bg-red-400 col-span-2"></div>
              <div className="bg-green-400 col-span-2"></div>
              <div className="bg-blue-400 col-span-2"></div>
              <div className="bg-gray-400"></div>
              <div className="bg-cyan-400 col-span-2"></div>
              <div className="bg-orange-400 col-span-2"></div>
